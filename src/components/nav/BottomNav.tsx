...
<Link href={href} className={`flex flex-col items-center justify-center gap-1 px-3 py-2 rounded-xl transition ${isActive(href) ? "bg-gray-900/80   " : " -400 hover:   hover:bg-gray-800/50"}`}>
...
<button onClick={onOpenActions} className="flex flex-col items-center justify-center gap-1 px-3 py-2 rounded-xl  -100 hover:bg-gray-800/50">
